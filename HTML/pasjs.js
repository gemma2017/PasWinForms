...
var Pas =
{
    ...
    newLayout:function()
    {
        ...
        var cards = new Array(8,29,0,43,36,31,10,15,46,23,32,34,18,27,35,40,3,4,16,12,1,45,22,20,50,5,49,44,41,26,24,51,48,6,28,14,39,9,37,7,42,17,13,25,2,38,52,21,30,53,11,33,47,19);
        for (row = 0; row < 6; row++)
        {
            for (col = 0; col < 9; col++)
            {
    ...
    if (number == 4)
            cards = new Array
        (8,29,0,43,36,31,10,15,46,23,32,34,18,27,35,40,3,4,16,12,1,45,22,20,50,5,49,44,41,26,24,51,48,6,28,14,39,9,37,7,42,17,13,25,2,38,52,21,30,53,11,33,47,19);
